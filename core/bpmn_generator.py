...
- У каждого task и каждого шлюза заполни `documentation`: одним предложением \
из текста описания — что происходит, кто делает и при каком условии. Имени шага \
для чтения процесса не хватает: схему правят, согласуют и ищут по описаниям \
шагов, а не по заголовкам. События без необходимости не документируй.
